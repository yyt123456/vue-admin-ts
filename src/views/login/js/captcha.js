    ...
    NEW_ACTION = function() {
      !(function(e) {
          ...
          function o(e) {
            return this instanceof o
              ? ((this._state = l),
                ...
                (this._value = null),
                (this._reason = null),
                void (p(e) && e(a(this.resolve, this), a(this.reject, this))))
              : new o(e);
          }
          function i(e, t, n) {
            return function(o) {
        ...
        function(e, t, n) {
          ...
          function o(e, t, n) {
            if (e) {
              let o = 0,
                i = e.length;
              if (i === +i) for (; o < i && t.call(n, e[o], o, e) !== !1; o++);
              else
                for (o in e)
          ...
          function i(e, t) {
            if (!t) return !1;
            if (e.classList) {
              for (let n = t.split(/\s+/), o = 0; o < n.length; o++)
          ...
          function r(e, t) {
            t &&
              !i(e, t) &&
              (e.classList
                ? e.classList.add.apply(e.classList, t.split(/\s+/))
                : (e.className += " " + t));
          }
          function a(e, t) {
            t &&
              i(e, t) &&
              (e.classList
                ? e.classList.remove.apply(e.classList, t.split(/\s+/))
          ...
          (t.each = o),
            ...
            (t.getElementsByClassName = function(e, t, n) {
              if (((t = t || u), (n = n || "*"), u.getElementsByClassName))
                return t.getElementsByClassName(e);
              for (
                var o = [],
                  r = "*" === n && t.all ? t.all : t.getElementsByTagName(n),
                  a = r.length;
                --a >= 0;
            ...
            (t.addHourStamp = function(e, t) {
              const n = Math.floor(new Date().getTime() / (36e5 * (t || 2))),
                o = e.indexOf("?") === -1 ? "?" : "&";
              return e + o + "_t=" + n;
            });
          const f = {};
          ...
          (t.getClientRect = function(e) {
            const t = u.documentElement.scrollTop;
          ...
          (t.decorator = h),
            (t.mix = function(e) {
              for (
                var t, n, o = [].slice.call(arguments), i = o.length, r = 1;
                r < i;
                r++
              ) {
                t = o[r];
            ...
            (t.request = function(e) {
              ...
              const r = u.getElementsByTagName("script")[0];
              return (
        ...
        function(e, t, n) {
          ...
          let p = "";
          p =
            d.indexOf("g.alicdn.com") != -1
              ? "https://g.alicdn.com/AWSC/AWSC/awsc.js"
              : "https://aeis.alicdn.com/AWSC/AWSC/awsc.js";
          const _ = {
            0: {
              analyze: s
              ...
              get_captcha_pre:
                "https://diablo.alibaba.com/captcha/click/pre_get.jsonp",
              get_img: "https://diablo.alibaba.com/captcha/image/get.jsonp",
              get_img_pre:
                "https://diablo.alibaba.com/captcha/image/pre_get.jsonp",
              checkcode: s
                ? "https://cf2.aliyun.com/captcha/checkcode.jsonp"
                : "https://cf.aliyun.com/captcha/checkcode.jsonp",
              cc: "https://diablo.alibaba.com/diablo/captcha_api/get.jsonp",
              cc_pre:
                "https://diablo.alibaba.com/diablo/captcha_api/pre_get.jsonp",
              awsc_Url: p,
              umid_serUrl: "https://ynuf.aliapp.org/service/um.json",
              api_prepare:
                "https://cf.aliyun.com/scratchCardSlide/prepare.jsonp",
              api_report:
                "https://cf.aliyun.com/scratchCardSlide/dataReport.jsonp",
              api_analyze:
                "https://cf.aliyun.com/scratchCardSlide/analyze.jsonp"
            },
            1: {
              analyze: "https://cfus.aliyun.com/nocaptcha/analyze.jsonp",
              initialize: "https://cfus.aliyun.com/nocaptcha/initialize.jsonp",
              get_captcha:
                "https://usdiablo.alibaba.com/captcha/click/get.jsonp",
              get_captcha_pre:
                "https://usdiablo.alibaba.com/captcha/click/pre_get.jsonp",
              get_img: "https://usdiablo.alibaba.com/captcha/image/get.jsonp",
              get_img_pre:
                "https://usdiablo.alibaba.com/captcha/image/pre_get.jsonp",
              checkcode: "https://cfus.aliyun.com/captcha/checkcode.jsonp",
              cc: "https://usdiablo.alibaba.com/diablo/captcha_api/get.jsonp",
              cc_pre:
                "https://usdiablo.alibaba.com/diablo/captcha_api/pre_get.jsonp",
              awsc_Url: p,
              umid_serUrl: "https://us.ynuf.aliapp.org/service/um.json",
              api_prepare:
                "https://cfus.aliyun.com/scratchCardSlide/prepare.jsonp",
              api_report:
                "https://cfus.aliyun.com/scratchCardSlide/dataReport.jsonp",
              api_analyze:
                "https://cfus.aliyun.com/scratchCardSlide/analyze.jsonp"
            },
            2: {
              ...
              umid_serUrl: "https://ynuf.aliapp.org/service/um.json",
              api_prepare:
                "https://cfun.aliyun.com/scratchCardSlide/prepare.jsonp",
              api_report:
                "https://cfun.aliyun.com/scratchCardSlide/dataReport.jsonp",
              api_analyze:
        ...
        function(e, t, n) {
          "use strict";
          (t.v = 1028), (t.version = "v1.2.20");
        },
        function(e, t, n) {
          "use strict";
          function o(e) {
            const t = ("_nc_r_" + Math.random()).replace(/\./, ""),
              n = (r[t] = new Image());
            (n.onload = n.onerror = function() {
              r[t] = null;
            }),
        ...
        function(e, t, n) {
          ...
          function i(e, t) {
            ...
            for (n in e)
              e.hasOwnProperty(n) &&
                ...
                "string" == typeof o && (o = [o]),
                (i[n] =
                  '<span class="nc-lang-cnt" data-nc-lang="' +
                  n +
                  '">' +
                  r(h[n], o) +
                  "</span>"));
          ...
          var s,
            ...
            f =
              "https://survey.taobao.com/survey/AMnMVgrS4?type=%TYPE&str=%STR",
            g = "{0}",
            h = {
              _startTEXT: g,
              _yesTEXT: "<b>{0}</b>",
            ...
            m = {
              ...
              en:
                ((s = {
                  ...
                  _ggk_guide:
                    "Hold your left mouse button down to scratch out two chickens",
                  _ggk_start: "",
                  _ggk_net_err: [
                ...
                o(
                  s,
                  "_ggk_success",
                  "Congratulations! You've got the chickens!"
                ),
                s),
              ar_SA: {
                _startTEXT:
              ...
              de_DE: {
                _startTEXT:
                  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bitte schieben Sie, um zu \xfcberpr\xfcfen",
                ...
                _error300: [
                  "Huch ... etwas ist schief gelaufen. Bitte ",
                  d,
                  "aktualisieren",
              ...
              es_ES: {
                ...
                _errorTooMuch: [
                  "Por favor, int\xe9ntelo de nuevo o ",
                  _,
                ...
                _errorTooMuchClick: [
                  "Por favor, int\xe9ntelo de nuevo o ",
                  _,
                  "m\xe1ndenos un comentario"
                ],
                _Loading: "Cargando",
                _errorServer: "Error del Servidor",
                _error300: [
                  "Vaya ... algo est\xe1 mal. Por favor ",
                  d,
                  "actualizar",
                  " y volver a intentar"
                ],
                _errorNetwork: [
                  "Error de red. Por favor, ",
                  d,
                  "actualice",
                  " o ",
                  _,
              ...
              in_ID: {
                ...
                _error300: [
                  "Ups... Ada yang salah. Silakan ",
                  d,
                  "refresh",
                  " dan coba lagi"
                ],
                _errorNetwork: [
                  "Kesalahan jaringan. Silakan ",
                  d,
                  "refresh",
                  ", atau ",
                  _,
              ...
              it_IT: {
                ...
                _errorLOADING: [
                  "La pagina non ha caricato, per favore ",
                  d,
                  "rinfresca",
                  " o ",
                  _,
                ...
                _error300: [
                  "Oooops... C'\xe8 qualcosa che non va. Per favore ",
                  d,
                  "rinfresca",
                  " la pagina o riprova."
                ],
                _errorNetwork: [
                  "Errore della Rete. Per favore ",
                  d,
                  "rinfresca",
                  " la pagina o ",
                  _,
              ...
              nl_NL: {
                ...
                _error300: [
                  "Oeps\u2026er is iets fout. Vernieuw en ",
                  d,
                  "probeer opnieuw",
                  ""
                ],
              ...
              pt_BR: {
                ...
                _errorLOADING: [
                  ...
                  " ou ",
                  _,
                  "envie-nos uma mensagem sobre o erro"
                ],
                _errorTooMuch: [
                ...
                _error300: [
                  "Opa... Aconteceu um erro. Por favor, ",
                  d,
                  "atualize",
                  " e tente novamente"
                ],
                _errorNetwork: [
                  "Erro de Rede. Por favor, ",
                  d,
                  "atualize",
                  " ou ",
                  _,
              ...
              ru_RU: {
                ...
                _errorServer:
                  "\u041e\u0448\u0438\u0431\u043a\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0430",
                _error300: [
                  "\u041e\u0439, \u0447\u0442\u043e-\u0442\u043e \u043f\u043e\u0448\u043b\u043e \u043d\u0435 \u0442\u0430\u043a. \u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, ",
                  d,
                  "\u043e\u0431\u043d\u043e\u0432\u0438\u0442\u0435",
                  " \u0438 \u043f\u043e\u043f\u0440\u043e\u0431\u0443\u0439\u0442\u0435 \u0435\u0449\u0435 \u0440\u0430\u0437"
                ],
                _errorNetwork: [
                  "\u041e\u0448\u0438\u0431\u043a\u0430 \u0441\u0435\u0442\u0438, \u043f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, ",
                  d,
                  "\u043e\u0431\u043d\u043e\u0432\u0438\u0442\u0435",
                  " \u0438\u043b\u0438 ",
                  _,
              ...
              th_TH: {
                ...
                _errorServer:
                  "\u0e40\u0e0b\u0e34\u0e23\u0e4c\u0e1f\u0e40\u0e27\u0e2d\u0e23\u0e4c\u0e02\u0e31\u0e14\u0e02\u0e49\u0e2d\u0e07",
                _error300: [
                  "Oops... \u0e1a\u0e32\u0e07\u0e2d\u0e22\u0e48\u0e32\u0e07 \u0e02\u0e31\u0e14\u0e02\u0e49\u0e2d\u0e07. \u0e01\u0e23\u0e38\u0e13 ",
                  d,
                  "\u0e32\u0e23\u0e35\u0e40\u0e1f\u0e23\u0e0a ",
                  " \u0e41\u0e25\u0e30\u0e25\u0e2d\u0e07\u0e2d\u0e35\u0e01\u0e04\u0e23\u0e31\u0e49\u0e07"
                ],
                _errorNetwork: [
                  "\u0e40\u0e04\u0e23\u0e37\u0e2d\u0e02\u0e48\u0e32\u0e22\u0e02\u0e31\u0e14\u0e02\u0e49\u0e2d\u0e07 \u0e01\u0e23\u0e38\u0e13\u0e32 ",
                  d,
                  "\u0e23\u0e35\u0e40\u0e1f\u0e23\u0e0a",
                  " \u0e2b\u0e23\u0e37\u0e2d ",
                  _,
              ...
              tr_TR: {
                ...
                _errorTooMuch: [
                  "L\xfctfen tekrar deneyin ve ya ",
                  _,
                  "geri bildirin."
                ],
                _errorTooMuchClick: [
                ...
                _error300: [
                  "T\xfch\u2026bir \u015feyler's ters. L\xfctfen ",
                  d,
                  "yenileyin",
                  " ve tekrar deneyin."
                ],
              ...
              vi_VN: {
                _startTEXT:
                  "Vui l\xf2ng tr\u01b0\u1ee3t \u0111\u1ec3 x\xe1c th\u1ef1c",
                ...
                _error300: [
                  "R\u1ea5t ti\u1ebfc... \u0111\xe3 x\u1ea3y ra sai s\xf3t. Vui l\xf2ng ",
                  d,
                  "l\xe0m m\u1edbi",
                  " v\xe0 th\u1eed l\u1ea1i."
                ],
                _errorNetwork: [
                  "L\u1ed7i m\u1ea1ng. Vui l\xf2ng ",
                  d,
                  "l\xe0m m\u1edbi",
                  ", ho\u1eb7c g\u1eedi ",
                  _,
                ...
                _OK: "OK",
                _sthWrong:
                  "R\u1ea5t ti\u1ebfc, \u0111\xe3 x\u1ea3y ra sai s\xf3t...",
                _reload: "T\u1ea3i l\u1ea1i",
                _feedback: "Ph\u1ea3n h\u1ed3i"
              }
            };
          ...
          function u(e, t) {
            ...
            o &&
              (n +=
                ...
                " */");
            const i = new Blob([n], { type: "text/css" }),
              r = e.href;
            ...
            return (
              ...
              function(e) {
                ...
                for (var a = 0; a < r.length; a++) {
                  var s = r[a];
                  if (0 === s.refs) {
                    for (let d = 0; d < s.parts.length; d++) s.parts[d]();
                    delete p[s.id];
                  }
                }
              }
          ...
          !(function() {
            var n = {
              ...
              create: function(e, t) {
                ...
                o &&
                  ((o.event = o.event || "startup"),
                  d({ name: o.event, from: "none", to: o.state }));
                for (let u = 0; u < a.length; u++) d(a[u]);
                for (var p in s)
                ...
                return (
                  ...
                  (r.can = function(e) {
                    return (
                      !this.transition &&
                      void 0 !== s[e] &&
                      (s[e].hasOwnProperty(this.current) ||
                        s[e].hasOwnProperty(n.WILDCARD))
                    );
                  }),
                  (r.cannot = function(e) {
                    return !this.can(e);
              ...
              beforeEvent: function(e, t, o, i, r) {
                if (
                  !1 === n.beforeThisEvent(e, t, o, i, r) ||
                  !1 === n.beforeAnyEvent(e, t, o, i, r)
                )
                  return !1;
              },
              ...
              leaveState: function(e, t, o, i, r) {
                const a = n.leaveThisState(e, t, o, i, r),
                  c = n.leaveAnyState(e, t, o, i, r);
                return (
                  !1 !== a &&
                  !1 !== c &&
                  (n.ASYNC === a || n.ASYNC === c ? n.ASYNC : void 0)
                );
              },
              ...
              buildEvent: function(e, t) {
                return function() {
                  const o = this.current,
                    i =
                      t[o] ||
                      (t[n.WILDCARD] != n.WILDCARD ? t[n.WILDCARD] : o) ||
                      o,
                  ...
                  if (o === i)
                    return (
                      n.afterEvent(this, e, o, i, r), n.Result.NOTRANSITION
                    );
                  const a = this;
                  ...
                  const c = n.leaveState(this, e, o, i, r);
                  return !1 === c
        ...
        function(e, t, n) {
          ...
          function o(e) {
            ...
            if (_.navigator.cookieEnabled && !n) {
              let r = f.cookie.indexOf(e + "=");
              if (r != -1) {
                r += e.length + 1;
                let a = f.cookie.indexOf(";", r);
          ...
          function c() {
            const e = (_._sec_module = _._sec_module || {});
          ...
          function o(e, t) {
            (this.id = function(e) {
              ...
              (this.loadjs = function(e, t, n) {
                ...
                const d = a.getElementsByTagName("script")[0];
              ...
              (this.jsonp = function(n) {
                ...
                let c = ("jsonp_" + Math.random()).replace(".", ""),
                  s = a.getElementsByTagName("script")[0],
                  l = "";
                n.data
                  ? ((n.data[n.callback] = c), (l += t(n.data)))
                  : (l += n.callback + "=" + c);
                let d = a.createElement("script");
        ...
        function(e, t, n) {
          ...
          e.exports = {
            ...
            obj_ok:
              "//img.alicdn.com/tfs/TB1OLQ7SFXXXXaoapXXXXXXXXXX-57-70.png",
            obj_fail:
              "//img.alicdn.com/tfs/TB1N4lDSVXXXXcFXpXXXXXXXXXX-57-66.png",
            obj_size: 70,
            bg_back:
              "//img.alicdn.com/tps/TB1ml9hPFXXXXcjXFXXXXXXXXXX-100-80.png",
            bg_front:
              "//img.alicdn.com/tps/TB1531mPFXXXXc_XpXXXXXXXXXX-100-80.png",
            err_TIMEOUT_uab:
              "//img.alicdn.com/tfs/TB1N4lDSVXXXXcFXpXXXXXXXXXX-57-66.png",
            err_TIMEOUT_um:
              "//img.alicdn.com/tfs/TB1N4lDSVXXXXcFXpXXXXXXXXXX-57-66.png",
        ...
        function(e, t, n) {
          ...
          var s,
            ...
            _ = {
              ...
              es_ES: {
                _ggk_guide:
                  "Mant\xe9n pulsado el bot\xf3n izquierdo del rat\xf3n para rascar dos pollos",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              pl_PL: {
                _ggk_guide:
                  "Przytrzymaj lewy przycisk myszy, aby zdoby\u0107 dwa kurczaki",
                _ggk_start: "",
                _ggk_net_err: [
                  "Problem z sieci\u0105.",
                  l,
                ...
                _ggk_loading: "\u0141aduj\u0119",
                _ggk_success:
                  "Gratulacje! Uda\u0142o Ci si\u0119 zdoby\u0107 kurczaki!"
              },
              fr_FR: {
                _ggk_guide:
                  "Maintenez appuy\xe9 le bouton gauche de la souris pour gratter deux poulets",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              de_DE: {
                _ggk_guide:
                  "Halten Sie die linke Maustaste gedr\xfcckt, um zwei H\xfchner zu kratzen",
                _ggk_start: "",
                _ggk_net_err: [
                ...
                _ggk_loading: "Lade",
                _ggk_success:
                  "Gl\xfcckwunsch! Sie haben die H\xfchner erwischt!"
              },
              it_IT: {
                _ggk_guide:
                  "Tieni premuto il tasto sinistro del mouse per grattare due polli",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              ru_RU: {
                _ggk_guide:
                  "\u0423\u0434\u0435\u0440\u0436\u0438\u0432\u0430\u0439\u0442\u0435 \u043d\u0430\u0436\u0430\u0442\u043e\u0439 \u043b\u0435\u0432\u0443\u044e \u043a\u043d\u043e\u043f\u043a\u0443 \u043c\u044b\u0448\u0438, \u0447\u0442\u043e\u0431\u044b \u0432\u044b\u0446\u0430\u0440\u0430\u043f\u0430\u0442\u044c \u0434\u0432\u0443\u0445 \u0446\u044b\u043f\u043b\u044f\u0442",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              ar_SA: {
                _ggk_guide:
                  "\u0627\u0633\u062a\u0645\u0631 \u0641\u064a \u0627\u0644\u0636\u063a\u0637 \u0639\u0644\u0649 \u0632\u0631 \u0627\u0644\u0645\u0627\u0648\u0633 \u0627\u0644\u0623\u064a\u0633\u0631 \u0644\u062d\u0630\u0641 \u062f\u062c\u0627\u062c\u062a\u064a\u0646",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              tr_TR: {
                _ggk_guide:
                  "2 adet tavu\u011fun \xfcst\xfcn\xfc \xe7izmek i\xe7in farenin sol tu\u015funu bas\u0131l\u0131 tutun",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              th_TH: {
                _ggk_guide:
                  "\u0e01\u0e14\u0e1b\u0e38\u0e21\u0e40\u0e21\u0e32\u0e2a\u0e4c\u0e14\u0e49\u0e32\u0e19\u0e0b\u0e49\u0e32\u0e22\u0e04\u0e49\u0e32\u0e07\u0e44\u0e27\u0e49\u0e40\u0e1e\u0e37\u0e48\u0e2d\u0e02\u0e39\u0e14\u0e40\u0e2d\u0e32\u0e44\u0e01\u0e48\u0e2a\u0e2d\u0e07\u0e15\u0e31\u0e27",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              vi_VN: {
                _ggk_guide:
                  "Nh\u1ea5n gi\u1eef n\xfat chu\u1ed9t tr\xe1i \u0111\u1ec3 c\xe0o ra hai con g\xe0",
                _ggk_start: "",
                _ggk_net_err: [
                  "M\u1ea1ng g\u1eb7p s\u1ef1 c\u1ed1.",
                  l,
              ...
              nl_NL: {
                _ggk_guide:
                  "Houd de linkermuisknop ingedrukt om twee kippen weg te strepen",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              iw_HE: {
                _ggk_guide:
                  "\u05d4\u05d7\u05d6\u05e7 \u05d0\u05ea \u05dc\u05d7\u05e6\u05df \u05d4\u05e2\u05db\u05d1\u05e8 \u05d4\u05e9\u05de\u05d0\u05dc\u05d9 \u05e2\u05dc \u05de\u05e0\u05ea \u05dc\u05d2\u05e8\u05d3 \u05d5\u05dc\u05d7\u05e9\u05d5\u05e3 \u05e9\u05ea\u05d9 \u05ea\u05e8\u05e0\u05d2\u05d5\u05dc\u05d5\u05ea",
                _ggk_start: "",
                _ggk_net_err: [
                  "\u05d3\u05d5\u05d5\u05d7 \u05e2\u05dc \u05d1\u05e2\u05d9\u05d4.",
                  l,
              ...
              in_ID: {
                _ggk_guide:
                  "Tahan tombol mouse kiri Anda untuk menggurat dua ekor ayam",
                _ggk_start: "",
                _ggk_net_err: [
        ...
        function(e, t, n) {
          ...
          t.init = function(e) {
            ...
            (t.onenterfail = function() {
              const t = (e.index > 0 ? e.index : 1, e.scrape.prefix);
              o.addClass(e.el, "nc-fail");
              const i = document.getElementById(t + "container");
              if (i && n.bg_back_fail) {
                const r = o.getElementsByClassName("nc-bg", i)[0];
        ...
        function(e, t, n) {
          ...
          t.init = function(e) {
            ...
            (t.onenterloading = function() {
              ...
              const n = e.scrape || i.create(e);
              (e.scrape = n),
                s
                  .resolve()
                  .then(function() {
                    let t = e._custom_state._on_loading;
                    return (
                      (t = Array.isArray(t) ? t : []),
                      t.length > 0
                        ? s.all(
                ...
                Object.defineProperty = function(t, n, o) {
                  ...
                  return (
                    Object.prototype.__defineGetter__ &&
                      "get" in o &&
                      Object.prototype.__defineGetter__.call(t, n, o.get),
                    Object.prototype.__defineSetter__ &&
                      "set" in o &&
                      Object.prototype.__defineSetter__.call(t, n, o.set),
            ...
            Array.prototype.indexOf ||
              (Array.prototype.indexOf = function(e) {
                ...
                if (
                  ...
                  return -1;
                for (
                  let i = o >= 0 ? o : Math.max(n - Math.abs(o), 0);
                  i < n;
                  i++
                )
                ...
                arguments.length > 1 &&
                  ...
                  o !== o
                    ...
                    : 0 !== o &&
                      ...
                      (o = (o > 0 || -1) * Math.floor(Math.abs(o))));
                for (
                  let i = o >= 0 ? Math.min(o, n - 1) : n - Math.abs(o);
                  i >= 0;
                  i--
                )
                  if (i in t && t[i] === e) return i;
        ...
        function(e, t, n) {
          ...
          function o(e) {
            ...
            e &&
              (t = e.filename + "") &&
              ((t = t.split("?")[0]),
              t.match(/(\/ncpc\/nc\.js$)|(\/uab\.js$)|(umscript.*\/um\.js$)/) &&
                (r.console && void 0, i()));
          }
          function i(e) {
            "function" == typeof ncDowngrade
              ? (ncDowngrade(), e && r.__nc && r.__nc.show())
              : e ||
                setTimeout(function() {
                  i(1);
                }, 100);
          ...
          r.addEventListener
            ...
            : r.attachEvent && r.attachEvent("onerror", o);
        },
        function(e, t, n) {
          "use strict";
          let o,
            i,
            r = "//g.alicdn.com/sd/ncpc/nc.css",
        ...
        function(e, t, n) {
          ...
          t.makeNC = function(e, t) {
                ...
                o.map(i, function(e) {
                  n[e] = function() {
                    ...
                    for (
                      ...
                      n[o] = arguments[o];
                    const i = this.__nc[e].apply(this.__nc, n);
                    return (
                      "destroy" === e && (this.is_destroyed = !0),
                      "getToken" === e || "getTrans" === e || "setTrans" === e
                        ? i
                        : this
                    );
                  };
            ...
            return (
              ...
              (a.reset = function(e) {
                const t = a.getByIndex(e);
                t
                  ? t.reset()
                  : window.outer_nc_list && window.outer_nc_list[e].reset();
              }),
              a
            );
          };
        ...
        function(e, t, n) {
          "use strict";
          function o(e, t) {
            return "undefined" != typeof UA_Opt[e] && UA_Opt[e] > 0
              ? UA_Opt[e]
              : t;
          }
          t.init = function(e) {
            (window.__sc_uaboption = new Object()),
              e.is_Opt
                ? ((UA_Opt.MPInterval = o("MPInterval", 4)),
                  ...
                  (window.__sc_uaboption.sIDs = o("sIDs", [
                    "_n1t|_n1z|nocaptcha|-stage-1"
                  ])),
                  (window.__sc_uaboption.mIDs = o("mIDs", [
                    "nc-canvas",
                    "click2slide-btn"
                  ])))
                : ((UA_Opt.SendInterval = 5),
                  ...
                  (window.__sc_uaboption.sIDs = [
                    "_n1t|_n1z|nocaptcha|-stage-1"
                  ]),
                  (window.__sc_uaboption.mIDs = [
                    "nc-canvas",
                    "click2slide-btn"
                  ]));
          };
          ...
          !(function(e) {
            ...
            if (!e[t]) {
              ...
              window.console ||
                ...
                n(69),
                n(72);
              const i = e.pointman && "19" == pointman._z,
                r = {},
                a = { has_pointman: i, index: 0, js_type: "pc", v: o };
              e.UA_Opt = e.UA_Opt || {};
              const c = n(74).makeNC(r, a);
              (c.v = o),
                (r.init = function() {}),
                a.has_pointman &&
                  ((r.noCaptcha = c),
            ...
            let o = e.prefix,
              ...
              k = function(e) {
                ...
                (this.service = {
                  ...
                  checkAudioURL:
                    "//cf.aliyun.com/captcha/checkcode.jsonp?csessionid={sessionid}&identity={identity}",
                  audioURL:
                    "{apiserver}/captcha/audio/get.jsonp?identity={identity}&sessionid={sessionid}",
                  audioURL_pre:
                    "{apiserver}/captcha/audio/pre_get.jsonp?identity={identity}&sessionid={sessionid}"
                }),
                  (this.cache = {
                    codeType: "img",
                    oldCode: null,
            ...
            return (
              (k.prototype = {
                render: function() {
                  ...
                  "[object String]" ==
                    Object.prototype.toString.call(t.element) &&
                    (t.element = m(t.element));
                  for (const n in this.service)
                    if (this.service.hasOwnProperty(n)) {
                      let o = this.service[n];
                      (o = o
                ...
                renderCode: function() {
                  ...
                  function i() {
                    ...
                    try {
                      noCaptcha.getByIndex(parseInt(o)).reload(),
                        n(c.switchevent, { from: "audio", to: "scale" });
                    } catch (i) {
                  ...
                  (d.className = "omeo-box"),
                    (d.innerHTML =
                      '<div class="omeo-code omeo-img-active" id="' +
                      o +
                      'omeo-code"><div class="omeo-code-img"><img id="' +
                      o +
                      'omeo-code-imgwrap" data-action="refreshImg" src="' +
                      a.service.imgURL +
                      '" onmousedown="return false;"/><a data-action="refreshImg" href="javascript:;" onmousedown="return false;" title="' +
                      s.refresh +
                      '" class="nc_iconfont btn_refresh omeo-code-refresh">&#xe607;</a><a data-action="switchToAudio" href="javascript:;" onmousedown="return false;" title="' +
                      s.audioText +
                      '" class="omeo-switch"></a></div><div class="omeo-code-audio"><div id="' +
                      o +
                      'omeo-code-audiobox" class="omeo-code-audiobox omeo-code-audiobox-playing"><a data-action="replayAudio" href="javascript:;">' +
                      s.clickPlay +
                      '</a><span id="' +
                      o +
                      'omeo-audio-process" class="omeo-audio-process"></span><b>' +
                      s.audioTips +
                      '</b></div><a id="' +
                      o +
                      'omeo-refresh-audio" data-action="refreshAudio" href="javascript:;" onmousedown="return false;" title="' +
                      s.refresh +
                      '" class="nc_iconfont omeo-code-refresh">&#xe607;</a><i id="' +
                      o +
                      '_voice_close" class="nc_voice_close nc_iconfont" >&#xe600;</i><a data-action="switchToImg" href="javascript:;" onmousedown="return false;" title="' +
                      s.imgText +
                      '" class="omeo-switch"></a></div></div><div class="omeo-code-echo"><input id="' +
                      o +
                      'omeo-code-key" type="text" name="code" maxlength="6" placeholder="' +
                      s.placeholder +
                      '" /><span class="omeo-code-state" id="' +
                      o +
                      'omeo-code-state"></span></div>'),
                    u.appendChild(d);
                  ...
                  u.addEventListener
                    ? (u.addEventListener(
                      ...
                      m(o + "omeo-code-imgwrap").addEventListener(
                        "error",
                        function() {
                          a.log({ e: "IMGERROR" }),
                      ...
                      p.addEventListener(
                        ...
                        function() {
                          e(),
                            a.validateCode({
                              code: m(o + "omeo-code-key").value.replace(
                                /^\s|\s$/g,
                                ""
                              )
                            });
                    ...
                    : (u.attachEvent("onclick", function(e) {
                        return a.triggerEvent(e), !1;
                      }),
                      m(o + "omeo-code-imgwrap").attachEvent(
                        "onerror",
                        function() {
                          a.log({ e: "IMGERROR" }),
                            "img" == a.cache.codeType && a.refreshCode();
                      ...
                      p.attachEvent("onkeyup", function() {
                        e(),
                          a.listenerCodeType(
                            m(o + "omeo-code-key").value.replace(/^\s|\s$/g, "")
                          );
                      }),
                ...
                listenerCodeType: function(e) {
                  (this.cache.oldCode &&
                    ...
                    e.length == this.config.codeLength &&
                      this.validateCode({ code: e });
                },
                ...
                resetPlayer: function(e) {
                  const t = m(o + "omeo-audio-process");
                  (t.style.width = 0),
                    "playing" == e.state
                      ? (t.parentNode.className =
                          "omeo-code-audiobox omeo-code-audiobox-playing")
                      : (t.parentNode.className = "omeo-code-audiobox"),
                    this.updateAudioBoxWidth();
                },
                refreshCode: function() {
                  const e = m(o + "omeo-code-state");
                ...
                switchCode: function(e) {
                  "img" == e.type
                    ? (this.stopAudio(),
                      (m(o + "omeo-code").className =
                        "omeo-code omeo-img-active"))
                    : ((m(o + "omeo-code").className =
                        "omeo-code omeo-audio-active"),
                      this.resetPlayer({ state: "playing" }),
                      !this.audioSupport ||
                        p ||
                        (m(o + "omeo-refresh-audio").style.display = ""),
                      this.playAudio()),
                ...
                playErrAudio: function() {
                  const e = "//g.alicdn.com/sd/ncpc/images/",
                    t = e + "error.wav",
                    n = e + "error_en.mp3",
                ...
                playAudio: function(e) {
                  function t(t) {
                    ...
                    t &&
                      ...
                      (n =
                        e.indexOf(".mp3") > -1 ? "audio/mpeg" : "audio/x-wav");
                    let c;
                    if (this.audioSupport)
                      ...
                      const s = r.createElement("bgsound");
                      s.setAttribute("id", "omeo-bgsound-audio" + a),
                        s.setAttribute("autostart", "true"),
                        s.setAttribute("src", e),
                        h.appendChild(s),
                        (this.cache.audioPlayer = m(
                          o + "omeo-bgsound-audio" + a
                        )),
                        this.resetPlayer({ state: "playing" });
                      let l = 0,
                        d = this;
                  ...
                  if ((n.stopAudio(), e)) t.call(n);
                    ...
                    const c = y
                      ...
                      .then(function() {
                        const o = { url: e, callback: "callback", data: {} };
                        return d.request(o).then(function(e) {
                          return e.success && 0 === e.result.resultCode
                            ? void t.call(n, e)
                            : s.reject({
                                type: "request",
                ...
                bindAudioProgress: function() {
                  ...
                  t.audio.addEventListener(
                    "timeupdate",
                    function() {
                      null !== m(o + "omeo-audio-process") &&
                        (!p || (this.duration && this.duration !== 1 / 0)
                          ? e.updateProgress(
                ...
                stopAudio: function() {
                  ...
                  this.audioSupport
                    ...
                    : e.audioPlayer &&
                      ((e.audioPlayer.src = ""),
                      e.audioPlayer.parentNode.removeChild(
                        this.cache.audioPlayer
                      ),
                      (e.audioPlayer = null));
                },
                ...
                loadResource: function(e, t) {
                  let n = null;
                  /\.css/g.test(e)
                    ? (r.createStyleSheet && r.createStyleSheet(e),
                      (n = r.createElement("link")),
                      (n.rel = "stylesheet"),
                      (n.href = e))
                    : ((n = r.createElement("script")), (n.src = e)),
                    "onload" in n
                      ? (n.onload = function() {
                          t && t();
                        })
                ...
                isIE: (function() {
                  return !!/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/.test(
                    u
                  );
                })(),
                audioSupport: (function() {
                  try {
                    return (
                      "Audio" in i && new Audio().canPlayType("audio/x-wav")
                    );
                  } catch (e) {
                    return !1;
                  }
                    ...
                    (n.cache.checkState = "codeError"),
                      ...
                      setTimeout(function() {
                        ...
                        e &&
                          ...
                          (e.value = ""),
                          e.focus(),
                          n.resetPlayer({ state: "playing" }),
                          n.playAudio());
                      }, 5e3);
                },
                check: function(e) {
                  "success" == this.cache.checkState &&
                    e &&
                    e({ message: "success" }),
                    "codeError" == this.cache.checkState &&
                      e &&
                      e({ message: "error" }),
        ...
        function(e, t, n) {
          ...
          function r(e) {
            ...
            const n = a.getElementsByTagName("script"),
              o = n[n.length - 1];
        ...
        function(e, t, n) {
          ...
          function i(e) {
            ...
            i.src =
              e.url + (e.url.indexOf("?") === -1 ? "?" : "&") + _.obj2param(n);
            ...
            (o.prototype = {
              ...
              render: function() {
                const e = this.language,
                  t =
                    ...
                    '\n</div>\n<div class="' +
                    T +
                    '-refresh" data-action="refresh"><i class="nc_iconfont" data-action="refresh">' +
                    y +
                    "</i>" +
                    e._cc_refresh +
                    '</div>\n<div class="' +
                    ...
                    '</div>\n<div class="' +
                    T +
                    '-cancel" data-action="close"><i class="nc_iconfont" data-action="close">' +
                    b +
                    "</i>" +
                    e._cancel +
                    '</div>\n</div>\n<div class="' +
              ...
              pin: function() {
                let e = this.options.$wrapper,
                  ...
                  r =
                    s.innerWidth || (d && d.clientWidth) || l.body.clientWidth,
                  a = "";
                r - t - n > i
                  ? ((a = "right"),
                ...
                if (this.status !== w.LOADING) {
                  ...
                  const o = m
                    ...
                    .then(function(e) {
                      return t.hasDestroy()
                        ? v
                        : e.success && 0 === e.result.resultCode
                        ? ((t.captchaToken = e.result.captchaToken),
                          p.all([r(e.result.data[0]), r(e.result.data[1])]))
                        : p.reject({
                            type: "request",
                            code: e.result.resultCode,
                            msg: e.result.message
                  ...
                  e ||
                    ...
                    o["catch"](function(n) {
                      /^(request|img)$/.test(n.type) &&
                        (t[n.type + "Fail"](e), t.onerror());
                    });
                }
              },
              bindEvents: function() {
                ...
                (t[w.LOAD_FAIL] = {
                  ...
                  (this._handler = _.bind(function(n) {
                    n = _.getEvent(n);
                    const o = _.getTarget(n),
                      i = o.getAttribute("data-nc-lang")
                        ? o.parentNode.getAttribute("data-action")
                        : o.getAttribute("data-action");
                    i &&
                      ("close" === i && (this.destroy(), e.reset()),
                      t[this.status] &&
                        t[this.status][i] &&
                        t[this.status][i].call(this, o, n));
                  }, this)),
                  _.addHandler(this.$container, "click", this._handler);
              },
              select: function(e, t) {
                if (
                  (_.toggleClass(e, T + "-selected"),
                  _.hasClass(e, T + "-selected"))
                ) {
                  let n = t.pageX,
                    o = t.pageY;
                  void 0 === n &&
                    (n = t.clientX + (l.body.scrollLeft || d.scrollLeft)),
                    void 0 === o &&
                      (o = t.clientY + (l.body.scrollTop || d.scrollTop));
                  const i = _.getPageCoord(e.parentNode);
                  e.setAttribute("data-x", n - i.x),
                    e.setAttribute("data-y", o - i.y),
                    e.setAttribute("data-ci", this.clickIndex++);
                }
                const r = this.klass("selected"),
                  a = r.length;
                0 === a
                  ? _.addClass(this.$confirm, T + "-disabled")
                  : _.removeClass(this.$confirm, T + "-disabled"),
                  c(this.$tip);
              },
              confirm: function() {
                let e = this,
                ...
                if (0 !== t.length && this.status !== w.VERIFING) {
                  this.setStatus(w.VERIFING),
                    ...
                    t.sort(function(e, t) {
                      let n,
                        o = parseInt(e.getAttribute("data-ci"), 10),
                  ...
                  _.each(t, function(e) {
                    ...
                    i({
                      ...
                      .then(function(t) {
                        return e.hasDestroy()
                          ? v
                          : void (t.success && 100 === t.result.code
                              ? (e.onsuccess(t.result.sig), e.destroy())
                              : (e.updateCaptcha(), a(e.$tip), e.onfail()));
                      })
                      ["catch"](function(t) {
              ...
              renderImg: function(e, t) {
                for (var n = "", o = 0; o < 9; o++)
                  n +=
                    ...
                    T +
                    '-item" data-action="select" data-i="' +
                    o +
                    '"><i class="nc_iconfont">' +
                    x +
                    "</i></a>";
              ...
              imgFail: function(e) {
                ...
                const i = n._cc_contact.replace("%TOKEN", this.options.token);
                t.innerHTML =
                  '\n<div class="' +
                  T +
                  '-fail">\n<div class="' +
              ...
              klass: function(e) {
                return _.getElementsByClassName(
                  [T, e].join("-"),
                  this.$container
                );
              },
        ...
        function(e, t, n) {
          ...
          t.makeNC = function(e, t, l) {
            function d(e, o, r, c) {
              const l = n(49).makeLog(o.foreign ? s.gj : s.gm),
                d = o.glog;
              "boolean" != typeof t._b_glog &&
                (t._b_glog = d && "number" == typeof d && Math.random() < d);
              let u = function(e) {
                t._b_glog &&
                  !h[e] &&
                  l.log(o.appkey, UA_Opt.Token || o.token, e);
                const n = r[e];
                if (n && n.length) {
                  let i,
                    a = [];
              ...
              return (
                (u = a.decorator.after(u, function(t) {
                  t === !1 &&
                    setTimeout(function() {
                      const t = window.outer_nc_list[e];
                      t && t.reload();
                    }, 1);
                })),
                [i(c, t, u), u]
        ...
        function(module, exports, __webpack_require__) {
          ...
          function makeNoCaptcha(
            ...
            function showError(e, t) {
              let n,
                o = t ? '<span class="nc-errcode"> (' + t + ")</span>" : "";
              if (e) {
                if (
                  ((n = language[opt.language]._errorNetwork + o),
              ...
              (n = n.replace("%TOKEN", opt.token)),
                ...
                (_.id(opt.renderTo).innerHTML =
                  '<div class="errloading"><i class="nc_iconfont icon_warn">' +
                  icon_warn +
                  "</i>" +
                  n +
                  "</div>"),
                el_render_to &&
                  util.removeClass(el_render_to, "show-click-captcha");
            }
            function NoCaptcha() {}
            var nc_index = inn_vars.index,
              ...
              glog = __webpack_require__(49).makeLog(
                opt.foreign ? mmstat_base.gj : mmstat_base.gm
              ),
              report = glog.report,
            ...
            const supportDataURI = new Promise(function(e, t) {
              return isIE8
                ? void t()
                : void util
                    .imageLoaded(
              ...
              (NoCaptcha.prototype = {
                init: function(e) {
                  ...
                  if (
                    ...
                    for (const n in e.upLang) _upLang(n, e.upLang[n]);
                  (this.render_to = opt.renderTo),
                    ...
                    opt.is_tbLogin &&
                      (tb_login = __webpack_require__(117).makeTBLogin(
                        inn_vars
                      )),
                  ...
                  if (opt.renderTo && opt.appkey && opt.token) {
                    i = _.id(opt.renderTo);
                    const r = Math.min(i.offsetWidth, i.parentNode.offsetWidth);
                    !opt.customWidth && r > 300 && (opt.customWidth = 300),
                      ...
                      i &&
                        (i.innerHTML =
                          ...
                          'nocaptcha"><div id="' +
                          nc_prefix +
                          'wrapper" class="nc_wrapper"><div id="' +
                          nc_prefix +
                          '_n1t_loading" class="nc_scale"><div id="' +
                          nc_prefix +
                          '_bg" class="nc_bg" style="width: 0;"></div><div id="' +
                          nc_prefix +
                          '_scale_text_loading" class="scale_text">' +
                  ...
                  if (
                    (opt.logo &&
                      css.insertCSS(
                        ".nc-container .nc_scale .scale_text {background-image: url(" +
                          NC_LOGO_URL +
                    ...
                    if (doc.createStyleSheet) doc.createStyleSheet(opt.cssUrl);
                      ...
                      (a.type = "text/css"),
                        ...
                        (a.href = inn_vars.has_pointman
                          ? util.addHourStamp(opt.cssUrl)
                          : opt.cssUrl);
                      const c = doc.getElementsByTagName("script")[0];
                ...
                initializationReport: function() {
                  const e = ("initializeJsonp_" + Math.random()).replace(
                      ".",
                      ""
                    ),
                    t =
                      ajaxURL.initialize +
                      "?a=" +
                      encodeURIComponent(opt.appkey) +
                      "&t=" +
                      encodeURIComponent(opt.token) +
                      "&scene=" +
                      encodeURIComponent(opt.scene) +
                      "&lang=" +
                      opt.language +
                      "&v=" +
                      ver.version +
                ...
                netErrorReport: function(e) {
                  try {
                    ...
                    const t = ("initializeJsonp_" + Math.random()).replace(
                        ".",
                        ""
                      ),
                      n =
                ...
                updateWidth: function(e, t) {
                  if (e) {
                    let n,
                      o,
                      i = "undefined" == typeof e ? "undefined" : _typeof(e);
                ...
                updateCSS: function(e, t, n) {
                  ...
                  css.insertCSS(
                    (n
                      ...
                      "px" +
                      r +
                      ";}\n.nc-container.tb-login .errloading, .nc-container .errloading {width:" +
                      (t - 10) +
                      "px;}"
                  );
                },
                updateAudioBoxWidth: function(e, t, n) {
                  const o = _.id(e + "omeo-refresh-audio").offsetWidth,
                ...
                try2setWidth: function(e, t) {
                  "string" == typeof e && (e = _.id(e)),
                    (t =
                      t ||
                      this.c_width ||
                      (el_render_to ? el_render_to.offsetWidth : 0)),
                ...
                loadJS: function() {
                  ...
                  window.AWSC
                    ...
                    : _.loadjs(
                        ...
                        function(t) {
                          t
                            ? (showError(!0, ERR_CODE_AWSCTIMEOUT),
                              e.netErrorReport(ERR_CODE_AWSCTIMEOUT))
                            : (e.loadUAB(), e.loadUM());
                        },
                ...
                jsReady: function() {
                  ...
                  !e.ready &&
                    e.__uab &&
                    e.__um &&
                    ((e.ready = !0), e.reload(), onNCEvent(event_names.ready));
                },
                loadUAB: function() {
                  const e = this;
                ...
                initUaParam: function() {
                  function e(e, t) {
                    UA_Opt[e] =
                      "undefined" != typeof UA_Opt[e] && UA_Opt[e] > 0
                        ? UA_Opt[e]
                        : t;
                  }
                  function t(e, t) {
                ...
                loadUM: function() {
                  ...
                  (window._umopt_npfp = 1),
                    opt.appkey &&
                      0 === opt.appkey.indexOf("X82Y") &&
                      (window._umopt_npfp = 0),
                    (window._umopt_cris = 0),
                    e.__um
                      ? e.jsReady()
                      : AWSC.use("um", function(t, n) {
                          if ("loaded" === t) {
                            const o = function r() {
                              let t = location.href || "";
                ...
                __reload_voicebtn: function() {
                  ...
                  _.addHandler(t, "keydown", function o(e) {
                    ...
                    (13 != n.keyCode && 13 != n.which) ||
                      (_.removeEvt(t, "keydown", o), t.click());
                  }),
                    (t.onclick = function() {
                      function t() {
                        r || n.umidToken.indexOf("defaultToken")
                          ? (clearInterval(c),
                            _.jsonp({
                              url: ajaxURL.analyze,
                              callback: "callback",
                          ...
                          : a++ > 100 &&
                            (showError(!0, ERR_CODE_UMXRETRYLIMIT),
                            clearInterval(c));
                      }
                      function o(t) {
                        function o(e) {
                          if (e.success)
                            if (100 == e.result.code)
                              ...
                              let t = _.id(nc_prefix + "_captcha_text"),
                                o = language[opt.language]._errorClickTEXT;
                              ++gErrTimes > MAX_ERR_TIME &&
                                (o = language[
                                  opt.language
                                ]._errorTooMuch.replace("%TOKEN", opt.token)),
                                (t.innerHTML =
                                  '<i class="nc_iconfont icon_close">' +
                                  icon_close +
                                  "</i>" +
                                  o),
                          ...
                          r &&
                            (objCheckCode ||
                              ...
                              objCheckCode.check(function(e) {
                                "success" != e.message &&
                                  (objCheckCode.playErrAudio(),
                                  setTimeout(function() {
                                    const e = _.id(
                                      nc_prefix + "omeo-refresh-audio"
                                    );
                                    e && e.click();
                                  }, 5e3)),
                                  "success" == e.message &&
                                    _.jsonp({
                                      ...
                                      data: {
                                        ...
                                        checkcode: (function() {
                                          ...
                                          return (
                                            (e.answer =
                                              objCheckCode.cache.lastCheckCode),
                                            _.obj2str(e)
                                          );
                                        })(),
                                        a: opt.appkey,
                      ...
                      if (
                        ((_.id(nc_prefix + "imgCaptcha").style.display =
                          "none"),
                        (_.id(nc_prefix + "clickCaptcha").style.display =
                          "none"),
                        e)
                      )
                        return (
                      ...
                      (e = !0),
                        ...
                        objCheckCode &&
                          (objCheckCode.resetPlayer({ state: "end" }),
                          objCheckCode.switchCode({ type: "audio" }));
                      var r,
                        a = 0;
                      setTimeout(function() {
                ...
                reload: function() {
                  ...
                  const e = _.id(opt.renderTo);
                  e &&
                    ((e.innerHTML = tpl),
                    util.addClass(el_render_to, "nc-container")),
                    opt.audio &&
                      ((_.id(nc_prefix + "_voicebtn").style.display = "block"),
                      util.addClass(_.id(nc_prefix + "n1t"), "is_audio")),
                    tb_login &&
                      tb_login.init(
                        this.render_to,
                        el_render_to,
                        opt.customFloatHeight
                      ),
                    this.__reload_voicebtn();
                  const t = _.id(nc_prefix + "_helpbtn");
                  t &&
                ...
                show: function() {
                  el_render_to &&
                    ((el_render_to.style.display = "block"),
                    tb_login && tb_login.adjustPosition(opt.customFloatHeight),
                    (this.is_show = !0));
                },
                hide: function() {
                  el_render_to &&
                    ((el_render_to.style.display = "none"),
                    (this.is_show = !1));
                },
                getTrans: function() {
                  return opt.trans;
                ...
                errorCallback: function(e) {
                  ...
                  if (
                    ...
                    showError(e),
                      ...
                      e &&
                        opt.error &&
                        opt.error(language[opt.language]._errorServer);
                  }
                },
                ...
                onScaleReady: function onScaleReady(elem) {
                  function waitForUmx() {
                    if (
                      ...
                      me.umidToken.indexOf("defaultToken")
                    ) {
                      clearInterval(timer);
                      try {
                        UA_Opt.sendSA();
                      ...
                      const t = {
                        ...
                        data: {
                          ...
                          t: opt.token,
                          n:
                            (me.__uab.getUA && me.__uab.getUA(me.__uaoption)) ||
                            win[UA_Opt.LogVal || "_n"] ||
                            "",
                          p: _.obj2str(trans),
                          scene:
                            opt.scene ||
                            (inn_vars.has_pointman
                              ? pointman.config.common.scene
                              : "") ||
                            "",
                          asyn: 0,
                          lang: opt.language,
                  ...
                  try {
                    trans.ncSessionID = this.getNcSession(
                      document.getElementById("nc_" + this._index + "_n1t")
                    );
                  } catch (e) {
                    trans.ncSessionID = "0";
                  }
                ...
                onScaleReadyCallback: function(e, t) {
                  if (e.success) {
                    ...
                    if (0 === o)
                      ...
                      (TEXTELEM.innerHTML =
                        language[opt.language]._Loading + loading_circle_html),
                      "function" == typeof opt.verifycallback &&
                        300 != o &&
                        opt.verifycallback(n),
                      100 == o)
                    )
                      (this.__inn = 1), this.onScale100(n.csessionid, n.value);
                    else if (200 == o)
                      (this.__inn = 1), this.onScale200(n.csessionid, n.value);
                      ...
                      if (
                        ...
                        (_.id(opt.renderTo).innerHTML =
                          ...
                          icon_warn +
                          "</i>" +
                          _upResetIndex(language[opt.language]._error300) +
                          "(error:" +
                          r +
                          ")</div>"),
                      ...
                      .then(function(e) {
                        _.jsonp({
                          ...
                          success: function(e) {
                            if (
                              (e.result.question &&
                                ((e.result.question = e.result.question.replace(
                                  /<span[^>]+?>/g,
                                  "<i>"
                                )),
                                (e.result.question = e.result.question.replace(
                              ...
                              const o = _.id(nc_prefix + "clickCaptcha");
                              o &&
                                ((o.style.display = "block"),
                                r.__is_c_width_setted ||
                                  r.updateWidth(
                                    _.id(nc_prefix + "wrapper"),
                                    1
                                  )),
                                el_render_to &&
                                  util.addClass(
                              ...
                              util.removeClass(
                                ...
                                _.id(nc_prefix + "_scale_text") &&
                                  (e.result.question.indexOf("<i>") == -1
                                    ? (_.id(
                                        nc_prefix + "_scale_text"
                                      ).innerHTML =
                                        p +
                                        "<i>\u201c" +
                                        e.result.tags[0] +
                                        "\u201d</i>" +
                                        u.join(e.result.tags[0]))
                                    : (_.id(
                                        nc_prefix + "_scale_text"
                                      ).innerHTML = e.result.question)),
                                tb_login &&
                                  tb_login.getInform(
                                    _.id(nc_prefix + "clickCaptcha"),
                                    module_nc.nc
                                  ),
                                (c[1].innerHTML =
                                  '<img src="' + e.result.data + '" >');
                              let f,
                                g = c[1].getElementsByTagName("img")[0];
                              (g.onload = function() {
                              ...
                              var h = setTimeout(function() {
                                (h = -1),
                                  f ||
                                    (showError(!0, ERR_CODE_IMAGE_TIMEOUT),
                                    report("captcha timeout"));
                              }, 5e3);
                ...
                onScale200: function t(e, n) {
                  function o(e) {
                    const t = _.id(nc_prefix + "captcha_input");
                    return (g = t.value.replace(/[^\w\/]/gi, ""))
                      ? (g.length > f.length
                          ? p.push(g.slice(f.length))
                          : g.length < f.length
                          ? p.push("bsp")
                          : p.push("oth"),
                        void (f = g))
                  ...
                  function i() {
                    const t = _.tag(nc_prefix + "imgCaptcha input")[0].value;
                    if (t) {
                      const o = { ksl: p.slice(0, 20) };
                      _.jsonp({
                        url: ajaxURL.checkcode,
                        callback: "callback",
                        data: {
                          ...
                          t: opt.token,
                          n:
                            (r.__uab.getUA && r.__uab.getUA(r.__uaoption)) ||
                            win._n ||
                            (UA_Opt.LogVal ? win[UA_Opt.LogVal] : "") ||
                            "",
                          p: _.obj2str(o),
                        ...
                        success: function(t) {
                          if (t.success) {
                            ...
                            if (100 == t.result.code)
                              ...
                              const r = _.tag(
                                nc_prefix + "imgCaptcha input"
                              )[0];
                              r && (r.value = ""),
                                UA_Opt.reload && UA_Opt.reload(),
                                c.call(s, e, n);
                              let a = language[opt.language]._errorTEXT;
                              ++gErrTimes > MAX_ERR_TIME &&
                                (a = language[
                                  opt.language
                                ]._errorTooMuch.replace("%TOKEN", opt.token));
                              const l = _.id(nc_prefix + "_captcha_img_text");
                              (l.innerHTML =
                                '<i class="nc_iconfont icon_close">' +
                                icon_close +
                                "</i>" +
                  ...
                  a &&
                    (this.__is_c_width_setted ||
                      this.updateWidth(_.id(nc_prefix + "wrapper"), 1));
                  var c = t,
                    s = this,
                    ...
                    d = supportDataURI
                      ...
                      .then(function(e) {
                        return e.success && 0 === e.result.resultCode
                          ? ((s.captchaToken = e.result.captchaToken),
                            util.imageLoaded(e.result.data[0]))
                          : Promise.reject({
                              type: "request",
                              code: e.result.resultCode,
                              msg: e.result.message
                      ...
                      .then(function(t) {
                        (a.style.display = "block"),
                          (l[1].innerHTML = ""),
                          l[1].appendChild(t);
                        const o = l[1].getElementsByTagName("img")[0];
                        _.addHandler(o, "click", function() {
                          ...
                          (_.id(nc_prefix + "scale_submit").innerHTML =
                            language[opt.language]._submit);
                      });
                  d["catch"](function(e) {
                    /^(request)$/.test(e.type)
                      ? showError(!0, ERR_CODE_IMAGE_REQUEST_ERROR)
                      : /^(img)$/.test(e.type) && showError();
                  });
                  var u,
                    p = [],
                    f = "",
                  ...
                  this.__inn &&
                    ...
                    window.addEventListener
                      ? _.id(nc_prefix + "captcha_input").addEventListener(
                          "input",
                          o
                        )
                      : _.id(nc_prefix + "captcha_input").attachEvent(
                          "onpropertychange",
                          function(e) {
                    ...
                    u &&
                      (u = u.getElementsByTagName("input")[0]) &&
                      _.addHandler(u, "keydown", function(e) {
                        if (
                          ((e = e || window.event),
                ...
                onScale260: function(e, t) {
                  ...
                  onNCEvent(event_names.beforeverify),
                    ...
                    (this.imgCategoryCaptcha = new ImgCategoryCaptcha(
                      ...
                      { v: inn_vars.v, obj2str: _.obj2str }
                    )),
                    onNCEvent(event_names.afterverify),
                    onNCEvent(event_names.after_code);
                },
                ...
                destroy: function() {
                  ...
                  let e,
                    t,
                    n,
                    o = util.getElementsByClassName(
                      "nc-custom-style-" + nc_index
                    );
                  if (
                    (util.getElementsByClassName("nc-required-js-" + nc_index),
                    (e = o.length),
                    e > 0)
                  )
                    for (t = 0; t < e; t++)
                      (n = o[0].parentNode), n && n.removeChild(o[0]);
                }
              }),
              NoCaptcha
            );
          ...
          var _typeof =
            ...
            MAX_ERR_TIME = 3,
            NC_LOGO_URL =
              "https://img.alicdn.com/tfs/TB1itI1PVXXXXXTXVXXXXXXXXXX-52-32.png",
            ...
            if (location.hostname.indexOf("alipay.com") !== -1) {
              ...
              if (t && "string" == typeof t) {
                ...
                if (n) {
                  ...
                  o &&
                    "_umfp" == o.id &&
                    (e.customWidth = e.customWidth || 300);
                }
              }
            }
          };
        ...
        function(e, t, n) {
          ...
          function i(e, t, n) {
            function i(e, n, i) {
              t.TEXTELEM &&
                ((t.TEXTELEM.innerHTML =
                  s[i.opt.language || l.language]._startTEXT),
                ...
                init: function(t) {
                  function o(o) {
                    ...
                    function a(e) {
                      ...
                      const t = (e || p.event).clientX,
                        o = _.min(y, _.max(-2, k + (t - v)));
                      (s.btn.style.left = o + "px"),
                        s.ondrag(_.round(100 * _.max(0, o / y)), o);
                      const i = x + s.bar.offsetWidth;
                      if (t >= i && (o < y || t - k < y))
                        return void f.call(this);
                      const a = c.getClientRect(s.btn).left;
                      (o != y && t - a - b != y) || r();
                    }
                    function f() {
                      const t = parseInt(s.btn.style.left);
                      t < y &&
                        (c.addClass(s.btn, "button_move"),
          ...
          function o(e, t, n) {
            ...
            function a() {
                ...
                function n() {
                  var t = 0,
                    ...
                    o = setInterval(function() {
                      (t += 5),
                        t > n
                          ? ((p.innerHTML = r[e.language]._Loading),
                            t > n + 100 &&
                              ((p.innerHTML = r[e.language]._yesTEXT),
                              clearInterval(o),
                              setTimeout(function() {
                                _.click();
                              }, 2e3)))
                          : ((f.style.left = s + 20 + t + "px"),
                            (u.style.left = t + "px"),
                            (p.style.width = t + "px"));
                    }, 16);
                }
              ...
              var a =
                  '<div id="' +
                  s +
                  '_help" class="nc_help"><div class="mask"></div><div id="' +
                  s +
                  '_slide_box" class="nc_scale"><div id="' +
                  s +
                  '_slide_button"></div><div id="' +
                  s +
                  '_slide_text" class="scale_text"></div><div id="' +
                  s +
                  '_slide_bg"></div></div><div id="' +
                  s +
                  '_btn_close"></div><div id="' +
                  s +
                  '_hand"></div>',
                c = n(a);
              ...
              var d = t.id(s + "_slide_box"),
                ...
                f = t.id(s + "_hand");
              return (
                (_.innerHTML = r[e.language]._closeHelp),
                (_.onclick = function() {
                  c.style.display = "none";
                }),
                o
          ...
          function o(e) {
            ...
            function r(e, t) {
              ...
              for (n = 0; n < r.length; n++)
                if (((o = r[n]), (i = o.className), i && i.indexOf(t) > -1))
                  return o;
              return null;
            }
            function a(e) {
              let n = t(g + "_scale_text"),
                o = r(e, "captcha-error");
              o ||
                ...
                e.appendChild(o)),
                (o.innerHTML = [
                  "<i class='nc_iconfont icon_ban'>&#xe603;</i>",
                  "<p class='error'>",
                  n.innerHTML,
                  "</p>"
                ].join(""));
            ...
            function c(e, t) {
              ...
              n.match(new RegExp("(^|\\s)" + t + "(\\s|$)")) ||
                (e.className = (e.className + " " + t).replace(
                  /^\s+|\s+$/g,
                  ""
                ));
            }
              ...
              if (f) {
                ...
                if (
                  (a =
                    t("J_LoginBox") ||
                    t("J_Login") ||
                    h.getElementsByClassName("nc-outer-box")[0])
                ) {
                  const c = p ? 0 : 2,
                    u = o(f),
                    _ = d;
                  if (u <= 0) {
                    ...
                    return (
                      (_._count = (_._count || 0) + 1), void setTimeout(_, 100)
                    );
                  }
                  let v,
                    b,
                  ...
                  "number" == typeof e
                    ? ((v = e), (b = 1))
                    : (v = k.height ? k.height : k.bottom - k.top);
                  let x, w;
                  (w = t(g + "imgCaptcha")),
                    w &&
                      ((w.style.top = y + c + "px"),
          ...
          function o(e) {
            const t = e.prefix,
              n =
                '\n<div id="' +
                t +
                'wrapper" class="nc_wrapper">\n<div id="' +
                t +
                'n1t" class="nc_scale">\n<div id="' +
                t +
                '_bg" class="nc_bg"></div>\n<span id="' +
                t +
                'n1z" class="nc_iconfont btn_slide">&#xe601;</span>\n<div id="' +
                t +
                '_scale_text" class="scale_text"></div>\n<div id="' +
                t +
                'clickCaptcha" class="clickCaptcha">\n<div class="clickCaptcha_text">\n<b id="' +
                t +
                '_captcha_text" class="nc_captch_text"></b>\n<i id="' +
                t +
                '_btn_2" class="nc_iconfont nc_btn_2 btn_refresh">&#xe607;</i>\n</div>\n<div class="clickCaptcha_img"></div>\n<div class="clickCaptcha_btn"></div>\n</div>\n<div id="' +
                t +
                'imgCaptcha" class="imgCaptcha">\n<div class="imgCaptcha_text"><input id="' +
                t +
                'captcha_input" maxlength="6" type="text" style="ime-mode:disabled"></div>\n<div class="imgCaptcha_img" id="' +
                t +
                '_imgCaptcha_img"></div>\n<i id="' +
                t +
                '_btn_1" class="nc_iconfont nc_btn_1 btn_refresh"\n    onclick="document.getElementById(\'' +
                t +
                '_imgCaptcha_img\').children[0].click()">&#xe607;</i>\n<div class="imgCaptcha_btn">\n<div id="' +
                t +
                '_captcha_img_text" class="nc_captcha_img_text"></div>\n<div id="' +
                t +
                'scale_submit" class="nc_scale_submit"></div>\n</div>\n</div>\n<div id="' +
                t +
                'cc" class="nc-cc"></div>\n<i id="' +
                t +
                '_voicebtn" tabindex="0" role="button" class="nc_voicebtn nc_iconfont" style="display:none" >&#xe604;</i>\n<b id="' +
                t +
                '_helpbtn" class="nc_helpbtn"></b>\n</div>\n<div id="' +
                t +
                '_voice" class="nc_voice"></div>\n</div>\n';
            return n;
          }
          t.makeTemplate = o;
        },
            ...
            p = (function() {
              function e(t, n, i) {
                ...
                t.foreign && ((r = "en"), (s.language = r)),
                  ...
                  this.el ||
                    a.fail(
                      "'renderTo'(" + t.renderTo + ") does not match any node."
                    ),
                  this.makeFSM(),
                  this.initStates(),
              ...
              return (
                i(e, [
                  ...
                  },
                  {
                    ...
                    value: function() {
                      this.is_destroyed ||
                        (this.fsm.destroy(), (this.is_destroyed = !0));
                    }
                  },
                  {
                    key: "_log",
                    value: function(e, t, n) {
                      const o = this.options,
                        i =
                          o.token ||
                          UA_Opt.Token ||
                          ("undefined" != typeof umx && umx.getToken
                            ? umx.getToken()
                            : "");
                      l.log({
                        a: o.appkey,
          ...
          const obj_w = -1,
            ...
            Scrape = (function() {
              function Scrape(e) {
                ...
                const n = {};
                if (
                  (t.foreign && (n.language = n.language || "en"),
                  ...
                  (this._last_y = -1),
                  (this.stroke_size =
                    t.stroke_size || cfg.default_stroke_width),
                  (this.svr_data = {}),
                  (this._t_action = null),
                  ...
                  for (const o in this.options.upLang)
                ...
                (this.scrapeStart = !1),
                  ...
                  this.reg();
                const i = URL_MAP[this.options.foreign] || URL_MAP[0];
                ...
                _createClass(Scrape, [
                    ...
                    value: function() {
                      ...
                      return new Promise(function(t, n) {
                        const o = e.options,
                          i = e.getParamOl(),
                          r =
                            (window.__sc__uab.getUA &&
                              window.__sc__uab.getUA(window.__sc_uaboption)) ||
                            win._n ||
                            (UA_Opt.LogVal ? win[UA_Opt.LogVal] : "") ||
                            "",
                        ...
                        e.baseFn.jsonp({
                          ...
                          success: function(o) {
                            ...
                            const a =
                              (e.nc.index > 0 ? e.nc.index : 1,
                              e.getEl("container"));
                            if (a && e.options.bg_back_prepared) {
                              const c = util.getElementsByClassName(
                                "nc-bg",
                                a
                              )[0];
                              c &&
                  ...
                  },
                  {
                    ...
                    value: function() {
                      ...
                      const t = this.el_canvas,
                        n = this.ctx,
                        o = this.size;
                      (t.width = o.width), (t.height = o.height);
                      const i = this.getEl("cover");
                      (i.style.width = o.width + "px"),
                        (i.style.height = o.height + "px");
                      const r = this.getEl("inform");
                      (n.fillStyle = "#ffffff"),
                        n.fillRect(0, 0, o.width, o.height);
                      for (
                        let a = this.nc.index > 0 ? this.nc.index : 1, c = 0;
                        c < util.getElementsByClassName("nc_bg").length;
                        c++
                      ) {
                        const s = util.getElementsByClassName("nc_bg")[c];
                        s &&
                          this.options.bg_back &&
                          c === a - 1 &&
                          (s.style.background =
                            "url(" + this.options.bg_back + ")");
                      }
                      const l = new Image();
                      (l.src = this.options.bg_front),
                        (l.onload = function() {
                          ...
                          for (
                            let e = l.naturalWidth
                                ? [l.naturalWidth, l.naturalHeight]
                                : [l.width, l.height],
                              t = _slicedToArray(e, 2),
                              i = t[0],
                              r = t[1],
                              a = Math.ceil(o.width / i),
                              c = Math.ceil(o.height / r),
                              s = 0;
                            s < c;
                            s++
                          )
                  ...
                  },
                  {
                    ...
                    value: function(e, t, n, o) {
                      for (
                        var i = this.ctx.getImageData(e, t, n, o).data,
                          r = 0,
                          a = 0;
                        a < i.length;
                        a += 4
                  ...
                  },
                  {
                    ...
                    value: function(e, t, n, o) {
                      for (
                        ...
                        for (let u = r; u < r + c; u++) {
                          const p = this._grid_x_count * d + u;
                          l += this.matrix[p];
                        }
                      return 1 - l / c / s;
                    }
                  },
                  {
                    ...
                    value: function() {
                      ...
                      const i = this.is_downgraded ? 0.7 : 0.9,
                        r = (this.obj_w / 2) * i,
                        a = (this.obj_h / 2) * i;
                      return (
                        (n = util.map(this._points, function(t) {
                          const n = t.x,
                            o = t.y;
                          return e._calcRegion_dg(
                            n - r,
                            o - a,
                            e.obj_w,
                            e.obj_h
                  ...
                  },
                  {
                    ...
                    value: function(e, t) {
                      ...
                      if (
                        ...
                        const i = [
                          win._n_bak,
                          this.baseFn.obj2str(this._prepare_result)
                        ];
                        (this.nc._err = "3A"),
                          (this._fail_msg = this._updateSurveyUrl(
                            this._lang._ggk_too_fast,
                            i
                          )),
                          this.verify_fail();
                      }
                            ...
                            _this10.baseFn.jsonp({
                              ...
                              success: function(e) {
                                if (e.success && e.result && e.result.success) {
                                  const t = e.result.result;
                                  if (0 === t.code)
                                    return _this10.verify_ok(t), void resolve();
                              ...
                              fail: function(e) {
                                _this10.nc._err =
                                  _this10.nc._err || FAIL_ANALYZE;
                                let t = _this10._lang._ggk_net_err;
                  ...
                  },
                  {
                    ...
                    value: function(e, t, n) {
                      ...
                      const o = this._mkErrInfo(this.nc._err, t, n);
                      return (
                        (e = e.replace(/%TYPE\b/, o.type)),
                      ...
                      return (
                        ...
                        Promise.resolve().then(function() {
                          if (e.options.is_tbLogin) {
                            e.hideEl("canvas-dg");
                            const t = e.getEl("nc-canvas");
                            (t.innerHTML =
                              '<div class="nc-tblogin-verify-success"><span><i class="ncpc_iconfont icon_ok">&#xe626;</i>\u9a8c\u8bc1\u5b8c\u6210</span></div>'),
                              (t.style.width = "300px"),
                              (t.style.height = "31px"),
                              (t.style.backgroundColor = "#D8FADF");
                            const n = e.options.callback;
                            "function" == typeof n && n(e.verify_result);
                          } else {
                            e.hideEl("canvas-dg");
                            const o = e.getEl("ok");
                            (o.style.marginTop =
                              (e.size.height - 80) / 2 + "px"),
                              (e.getEl("ok-msg").innerHTML =
                                e._lang._ggk_success);
                            const i = e.options.callback;
                  ...
                  },
                  {
                    ...
                    value: function() {
                      const e = this.getEl("fail-icon"),
                        t = this.getEl("load-error-icon");
                      if (
                        ((t.src = e.src = this.options.obj_fail), this.nc._err)
                      ) {
                        const n = this.getErrIcon(this.nc._err);
                        n && (t.src = e.src = n);
                      }
                      this.nc._err = "";
                    }
                    ...
                    value: function() {
                      ...
                      return Promise.resolve().then(function() {
                        ...
                        (t.style.marginTop = (e.size.height - 80) / 2 + "px"),
                          e.hideEl("canvas-dg"),
                          (e.nc._err = "5A");
                        let n = e._lang._ggk_action_timeout;
                    ...
                    value: function() {
                      ...
                      return new Promise(function(t, n) {
                        try {
                          const o = e.nc;
                          if (
                            ((e.root.innerHTML = kvTpl.render(html, {
                              nc: o,
                              prefix: e.prefix,
                              inform: "",
                            ...
                            e.bindEvents(),
                            (e.size = e.getSize()),
                            (e.getEl("container").style.width =
                              e.size.width + "px"),
                            e.render_bg(),
                            (e.el_canvas = e.getEl("canvas")),
                            !e.el_canvas.getContext ||
                              !(e.ctx = e.el_canvas.getContext("2d")))
                          )
                            return (
                              e.downgrade(), e.render_surface_dg(), void t()
                            );
                          e.render_surface(), t();
                        } catch (i) {
                          n(i);
        ...
        function(e, t, n) {
          ...
          function o(e, t, n) {
            ...
            (a = s.mix(a, e.apimap)),
              ...
              s.loadScript(
                s.addHourStamp(a.awsc_Url),
                function(e) {
                  if (AWSC) {
                    const t = function() {
                      if (window.__sc__uab) {
                        if ((clearInterval(n), "timeout" === window.__sc__uab))
                          return void o(u);
                        o(e);
                      }
                    };
                    AWSC.use("uab", function(e, t) {
                      "loaded" === e
                        ? (window.__sc__uab = t)
                        : "timeout" === e && (window.__sc__uab = "timeout");
                    });
          ...
          function a() {
            function e() {
              (n || umx.getStatus()) && c.__acjs
                ? clearInterval(o)
                : t++ > 100 && clearInterval(o);
            }
            if (!p) {
              p = !0;
              var t = 0,
